...
<footer class="footer">
    <div class="container clearfix" id="fotterUpdateWX">
        <div class="code fr" style="float: right">
            <div class="fr" style="float: right">
                <h3 id="fotterH3" style="margin: 0">关注微信账号</h3>
                <img src="${basePath}/res/common/images/code.jpg" />
            </div>
            <div class="fl" style="padding-top:50px;float: left">
                立即关注微信账号redoop。<br />
                免费获取<br />
                红象云腾大数据建设成功案例和方案。
            </div>
        </div>
        <div class="contact fl" style="float: left">
            <h3  id="fotterH31" style="margin:0;">联系我们</h3>
            <p>
                Tel: 400-0389-155 <br />
